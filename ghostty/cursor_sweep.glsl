// The shader can be found here: https://github.com/sahaj-b/ghostty-cursor-shaders
// -- CONFIGURATION --
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    vec4 previousCursor =
      vec4(normalize(iPreviousCursor.xy, 1.), normalize(iPreviousCursor.zw, 0.));
    ...
    if (lineLength > minDist) {
        ...
        vec2 v0 = vec2(head_pos_tl.x + currentCursor.z * isTopRightLeading,
                       head_pos_tl.y - currentCursor.w);
        ...
        vec2 v3 = vec2(tail_pos_tl.x + currentCursor.z * isTopRightLeading,
                       tail_pos_tl.y - previousCursor.w);
